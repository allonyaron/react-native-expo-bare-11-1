...
const PaymentMethod = () => {
	const { setIsCurrency, paymentType, setPaymentType } = useContext(CheckoutContext);

	const [isActive, setIsActive] = useState(true);
	// let test = isTestCurrency ? "true" : "false";
	// let testOnPress = () => setIsTestCurrency(isTestCurrency + 1);
	return (
		<View>
			<View style={[styles.paymentMethodContainers]}>
				...
				>
					<Image style={styles.checkImage} source={paymentType === 'CREDITCARD' ? checked : unchecked} />
				</TouchableOpacity>
			...
			<View style={[styles.paymentMethodContainers]}>
				...
				>
					<Image style={styles.checkImage} source={paymentType === 'MILES' ? checked : unchecked} />
				</TouchableOpacity>
			...
			<View style={[styles.paymentMethodContainers]}>
				<TouchableOpacity
					...
					onPress={() => {
						setIsCurrency(true);
						setPaymentType('JOINTAB');
					}}
				>
					<Image style={styles.checkImage} source={paymentType === 'JOINTAB' ? checked : unchecked} />
				</TouchableOpacity>
